...
<div class="page-header">
    ...
    <a href="{{ route('barang.index') }}" class="btn btn-neutral">&#8592; Kembali</a>
</div>

<div class="form-card">
    <form method="POST" action="{{ route('barang.update', $barang) }}" enctype="multipart/form-data" novalidate>
        @csrf
        @method('PUT')
        ...
        <div class="form-actions">
            ...
            <a href="{{ route('barang.index') }}" class="btn btn-neutral">Batal</a>
        </div>
    </form>
</div>
